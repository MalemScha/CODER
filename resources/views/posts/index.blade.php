            ...
            <div class="col-md-9 col-md-push-3 primary">
                @foreach($posts as $post)
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="level">
                        <a href="{{$post->path()}}" class="flex">
                            <h3 >{{$post->title}}</h3>
                            <a href="" class=" btn btn-xs btn-primary mr-1">{{ $post->channel->name}}</a><strong class="mr-1"><i class="fa  fa-commenting" aria-hidden="true"></i>{{$post->comments_count}}</strong>
                        </a>
                        </div>


                        posted by:
                        <a href="{{url('/@' . $post->creator->name)}}">{{$post->creator->name}}</a><br>{{$post->created_at->diffForHumans()}}
